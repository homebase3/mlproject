...
def objective(trial):
  ...
  cv_score = cross_val_score(estimator = transformed_xgb_model, X = X_xgb, y = y, cv = 5, scoring = 'neg_root_mean_squared_error', fit_params = fit_params, verbose = False)
...
cross_val_score(xgb_model,X_xgb,y,cv=5,scoring = 'neg_root_mean_squared_error')
```
